...
A link-free reading copy of the curriculum gists. The order follows the table of contents. The note is deliberately outside the guided-tour navigation chain.

## Unit 1 — Models, inference, and local hardware (~8–10h)
1. LLMs and the model/application boundary
...
2. Tokens, context windows, decoding, and inference
...
3. Local AI hardware: VRAM, unified memory, bandwidth, quantization, and model fit
...
3. Effort levels, writing style, and response contracts
...
4. Skills, tool discovery, and capability management
...
3. Planning, checkpoints, and durable state
...
4. Execution planes and sandboxing
...
5. Process, container, gVisor, microVM, and VM trade-offs
...
3. Debate, voting, reputation, and governance
