...
> Two teams can use the same AI model and get wildly different results depending on how they build the harness around it. This note walks through each part of that machinery.
